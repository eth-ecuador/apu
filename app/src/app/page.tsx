        ...
        {authenticated ? (
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="mt-8 flex gap-4">
              <a
                href="/patient"
                className="flex-1 p-6 border-2 border-blue-200 rounded-lg hover:border-blue-400 transition-colors"
              >
                <h3 className="text-lg font-semibold mb-2">Patient Portal</h3>
                <p className="text-sm text-gray-600">
                  Submit your medical data and receive AI-powered diagnosis
                </p>
              </a>

              <a
                href="/doctor"
                className="flex-1 p-6 border-2 border-green-200 rounded-lg hover:border-green-400 transition-colors"
              >
                <h3 className="text-lg font-semibold mb-2">Doctor Portal</h3>
                <p className="text-sm text-gray-600">
                  Review patient diagnoses and access encrypted medical data
                </p>
              </a>
            </div>
          </div>
