...
contract MedicalDataRegistry is ZamaEthereumConfig, Ownable2Step, ReentrancyGuard {
    ...
    function submitPatientData(
        externalEuint32 calldata encryptedRiskScore,
    ...
    function storeDiagnosis(
        address patient,
        externalEuint32 calldata encryptedDiagnosis,
        bytes calldata proof,
